...
# Paths to datasets
DATA_PATHS = {
    "pg": {"val": "data/preprocessed/pg_val_label.csv", "test": "data/preprocessed/pg_test_label.csv"},
    "mt": {"val": "data/preprocessed/mt_val_label.csv", "test": "data/preprocessed/mt_test_label.csv"},
    "dm": {"val": "data/preprocessed/dm_val_label.csv", "test": "data/preprocessed/dm_test_label.csv"}
}
...
def process_dataset_with_evaluation(dataset_name, val_file, test_file, best_threshold=None):
    ...
    # Save results
    #val_results.to_csv(f"data/{dataset_name}_val_bertscore_predictions.csv", index=False)
    test_results.to_csv(f"data/{dataset_name}_bertscore_predictions.csv", index=False)
